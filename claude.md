...
- Data from the UK professor will be ingested as flat files initially.

---

## Coding Conventions

- Python: snake_case, Pydantic models for all request/response shapes
- React Native: PascalCase components, camelCase props
- Database fields (future Supabase): snake_case matching Python models
- All Incident coordinates stored as `{ latitude, longitude }` — not `lat/lng` or `coords`
